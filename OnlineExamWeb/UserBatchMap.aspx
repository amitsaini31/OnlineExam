<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserBatchMap.aspx.cs" Inherits="OnlineExamWeb.UserBatchMap" %>
            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item selected"><a class="sidebar-link sidebar-link active" href="UserBatchMap.aspx"
                            aria-expanded="false"><i data-feather="database" class="feather-icon"></i><span
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Add Users to Batch</h3>
            ...
            <div class="container-fluid">
                ...
                <form id="id" runat="server">
                    ...
                    <input type="hidden" id="hdnbatchuser" runat="server" />
                    <div class="row" id="dvAdd" runat="server">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Add User to Batch</h4>
                                    <h6 class="card-subtitle">Add new user to batches.</h6>


                                    <div class="form-body">
                                        <div class="form-group">
                                            <div class="row">
                                                <label class="col-lg-2">Batch Name</label>
                                                <div class="col-lg-10">
                                                    <asp:DropDownList ID="ddlBatch" runat="server" class="form-control"></asp:DropDownList>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-10">
                                                    <%--<textarea class="form-control" rows="3" runat="server" id="txtbatchdesc" placeholder="Batch Description"></textarea>--%>
                                                    <asp:TextBox runat="server" class="form-control" ID="txtusername" placeholder="Search User Name..." />
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="row" id="dvView" runat="server">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">View Users in Batch</h4>
                                    <h6 class="card-subtitle">User added to batches.</h6>
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <label class="col-lg-2">Batch Name</label>
                                                <div class="col-lg-10">
                                                    <asp:DropDownList ID="ddlBatch1" runat="server" class="form-control"></asp:DropDownList>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#txtusername").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: '<%=ResolveUrl("~/UserBatchMap.aspx/GetUsers") %>',
        ...
        function InitialLoad() {
            if ($("#ddlBatch1").val() >= 0) {
                $.ajax({
                    type: "GET",
                    url: $("#hdnapi").val() + "/" + $("#ddlBatch1").val() + "/" + $("#hdnu").val() + "/getuserbatch",
                    //data: '{"productid" : "0"}',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: Onloadbatch,
        ...
        function Onloadbatch(response) {
            ...
            if (obj.Table.length == 0) {
                ...
                for (var i = 0; i < obj.Table.length; i++) {
                    ...
                    str = str + "<tr><td  style='text-align:left;'>" + item.BatchName + "</td><td  style='text-align:left;'>" + item.UserName + "</td></tr>";
                }
                $("#tbody").html(str);
                $("#tblView").show();
                $("#dvAdd").hide();
        ...
        function loadbatchforedit(id) {
            $.ajax({
                type: "GET",
                url: $("#hdnapi").val() + "/" + $("#hdnu").val() + "/getbatch",
                //data: '{"productid" : "0"}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: Onloadbatchforedit,
                failure: function (response) {
                    alert(response.responseText);
                },
                error: function (response) {
        ...
        function Onloadbatchforedit(response) {
            var obj = jQuery.parseJSON(response);
            debugger;
            //var Title = obj.Table.length;
            var str = "";
            ...
            for (var i = 0; i < obj.Table.length; i++) {
                var item = obj.Table[i];
                $("#txtbatchname").val(item.BatchName);
                $("#txtbatchdesc").val(item.BatchDescription);
                $("#hdnid").val(item.ID);
            }
            $("#dvAdd").show();
            $("#dvView").hide();
