<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Results.aspx.cs" Inherits="OnlineExamWeb.Results" %>
    ...
    <form runat="server">
                ...
                <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-7 align-self-center">
                            <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Results</h3>
        ...
        <script>
            ...
            function Initialload() {
                $.ajax({
                    type: "GET",
                    url: $("#hdnapi").val() + $("#hdnu").val() + "/getresult",
                    //data: '{"productid" : "0"}',
            ...
            function OnInitialLoadSuccess(response) {
                ...
                for (var i = 0; i < obj.Table.length; i++) {
                    ...
                    str = str + "<tr><td><a href='ListUsers.aspx?code=" + item.QuestionPaperCode + "'>" + item.QuestionPaperCode + "</a></td><td>"
                        + item.Title + "</td><td>"
                        + item.TotalQuestions + "</td><td>" +
                        item.TotalAttemptedQuestions + "</td><td>" +
                        item.TotalCorrectQuestions + "</td><td>" +
                        item.MarksObtained + "%</td></tr>";
                }
                $("#tbody").html(str);
