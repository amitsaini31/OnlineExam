<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchTest.aspx.cs" Inherits="OnlineExamWeb.SearchTest" %>
    ...
    <form runat="server">
            ...
            <aside class="left-sidebar" data-sidebarbg="skin6">
                ...
                <div class="scroll-sidebar" data-sidebarbg="skin6">
                    ...
                    <nav class="sidebar-nav">
                        <ul id="sidebarnav">
                            <li class="sidebar-item selected"><a class="sidebar-link sidebar-link active" href="SearchTest.aspx"
                ...
                <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-7 align-self-center">
                            <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Search & Subscribe Test</h3>
        ...
        <script>
            $(document).ready(function () {
                ...
                $(".subscribetest").click(function () {
                    var data = $(this).attr('data-val');

                    $.ajax({
                        type: "POST",
                        url: $("#hdnapi").val() + $("#hdnu").val() + "/" + data + "/subscribe",
                        //data: '{"productid" : "0"}',
            ...
            function loadbatch() {
                $.ajax({
                    type: "GET",
                    url: $("#hdnapi").val() + "/" + $("#hdnu").val() + "/getallquestionpaper",
                    //data: '{"productid" : "0"}',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: Onloadbatch,
                ...
                if (obj.Table.length == 0) {
                    ...
                    for (var i = 0; i < obj.Table.length; i++) {
                        ...
                        str = str + '<div class="col-sm-12 col-md-6 col-lg-4" id="' + item.QuestionPaperCode + '">' +
                            ...
                            ' <a class="btn btn-success subscribetest" href="#" data-val="' + item.QuestionPaperCode + '">Subscribe</a>' +
                            ' </div>' +
                            ' </div>' +
                            '</div>';
                    }
