<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListUsers.aspx.cs" Inherits="OnlineExamWeb.ListUsers" %>
...
<body>
    <form runat="server">
                ...
                <div class="scroll-sidebar" data-sidebarbg="skin6">
                    ...
                    <nav class="sidebar-nav">
                        <ul id="sidebarnav">
                            ...
                            <li class="sidebar-item selected"><a class="sidebar-link sidebar-link active" href="Results.aspx"
                                aria-expanded="false"><i data-feather="database" class="feather-icon"></i><span
                ...
                <div class="container-fluid">
                    ...
                    <div class="row" id="dvView">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">View Reults</h4>
        ...
        <script>
            $(document).ready(function () {
                ...
                $(".connect").click(function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: $("#hdnapi").val() + data + "/" + $("#hdnu").val() + "/connectuser",
                        //data: '{"productid" : "0"}',
            ...
            function Initialload() {
                $.ajax({
                    type: "GET",
                    url: $("#hdnapi").val() + $("#hdnu").val() + "/" + $("#hdncode").val() + "/getuserresult",
                    //data: '{"productid" : "0"}',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
            ...
            function OnInitialLoadSuccess(response) {
                ...
                for (var i = 0; i < obj.Table.length; i++) {
                    ...
                    str = str + "<tr id=" + item.UserID + "><td><a href='Profile.aspx?code=" + item.UserID + "'>" + item.Email + "</td><td>" +
                        //+ item.TotalQuestions + "</td><td>" +
                        //item.TotalAttemptedQuestions + "</td><td>" +
                        //item.TotalCorrectQuestions + "</td><td>" +
                        item.MarksObtained + "%</td><td><a class='btn btn-primary connect' href='#' data-val='" + item.UserID +"'>Connect</a></tr>";
                }
                $("#tbody").html(str);
        ...
        <asp:HiddenField ID="hdncode" runat="server" Value="0" />
        <asp:HiddenField ID="hdnapi" runat="server" Value="" />
         <asp:HiddenField ID="hdnu" runat="server" Value="" />
    </form>
