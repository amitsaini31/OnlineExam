<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserQuestion.aspx.cs" Inherits="OnlineExamWeb.UserQuestion" ValidateRequest="false" %>
...
<body>
            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item  selected"><a class="sidebar-link sidebar-link active" href="UserQuestion.aspx"
                            aria-expanded="false"><i data-feather="database" class="feather-icon"></i><span
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h6 class="card-subtitle">Shows Questons which are posted by you.</h6>
                                    <div class="form-body">
                                        <div class="form-group">
                                            <div class="form-actions">
                                                <div class="text-left">
    ...
    <script>
        ...
        function loadquestion() {
            $.ajax({
                type: "POST",
                url: $("#hdnapi").val() + "/" + $("#hdnu").val() + "/filluserquestion",
                //data: '{"productid" : "0"}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: Onloadquestion,
        ...
        function Onloadquestion(response) {
            ...
            if (obj.Table.length == 0) {
                ...
                for (var i = 0; i < obj.Table.length; i++) {
                    ...
                    //str = str + "<tr><td  style='text-align:left;'>" + item.QuestionPaperCode
                    //    + "</td><td  style='text-align:left;'>" + item.Question
                    //    + "</td><td><a href='UserQuestion.aspx?ecode=" + item.ID
                    //    + "'><i class='fas fa-edit action edit' ></i></a><a href='#' onclick='loadbatchforedit(" + item.ID
                    //    + ")' data-original-title='Delete'><i class='fas fa-trash delete'></i></a></td></tr>";
                ...
                $('tr').click(function () {
                    ...
                    $("#mdltitle").html("ID : "
                        + $(this).attr('data-id'));
                    $("#mdledit").html("<a class='btn btn-primary' href='UserQuestion.aspx?ecode="
                        + $(this).attr('data-id') + "'>Edit</a> ");

                    $("#mdldelete").html("<a class='btn btn-primary' href='UserQuestion.aspx?dcode="
