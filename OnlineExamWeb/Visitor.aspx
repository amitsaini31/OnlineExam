<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Visitor.aspx.cs" Inherits="OnlineExamWeb.Visitor" %>
    ...
    <form runat="server">
                        ...
                        <ul class="navbar-nav float-right">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                    <a class="dropdown-item" href="MyProfile.aspx"><i data-feather="user"
                ...
                <div class="scroll-sidebar" data-sidebarbg="skin6">
                    ...
                    <nav class="sidebar-nav">
                        <ul id="sidebarnav">
                            ...
                            <li class="sidebar-item selected"><a class="sidebar-link sidebar-link active" href="Visitor.aspx"
                                aria-expanded="false"><i data-feather="database" class="feather-icon"></i><span
                            ...
                            <li class="nav-small-cap"><span class="hide-menu">Practice</span></li>
                              <li class="sidebar-item"><a class="sidebar-link sidebar-link" href="PracticeQuestions.aspx"
                ...
                <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-7 align-self-center">
                            <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Assigned Tests</h3>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mt-4">
                                    ...
                                    <button class="btn btn-success" type="button">Start Test</button>
        ...
        <script>
            ...
            function loadbatch() {
                $.ajax({
                    type: "GET",
                    url: $("#hdnapi").val() + "/" + $("#hdnu").val() + "/getuserquestionpaper",
                    //data: '{"productid" : "0"}',
            ...
            function Onloadbatch(response) {
                ...
                if (obj.Table.length == 0) {
                    ...
                    for (var i = 0; i < obj.Table.length; i++) {
                        ...
                        str = str + '<div class="col-sm-12 col-md-6 col-lg-4" id="' + item.QuestionPaperCode + '">' +
                            ' <div class="card">' +
                            '<div class="card-body">' +
                            '  <h4 class="card-title">Code : ' + item.QuestionPaperCode + '</h4>' +
                            ' <h6 class="card-subtitle">Question Count : ' + item.QuestionCount + '</h6>' +

                            ' <a class="btn btn-success" href="Test.aspx?code=' + item.QuestionPaperCode + '">Start Test</a>' +
                            ' <button class="btn btn-danger removetest" type="button" data-val="' + item.QuestionPaperCode + '">Remove</button>' +
                    ...
                    $(".removetest").click(function () {
                        ...
                        $.ajax({
                            type: "POST",
                            url: $("#hdnapi").val() + $("#hdnu").val() + "/" + data + "/removetest",
                            //data: '{"productid" : "0"}',
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            success: Onloadbatch,
