<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Connection.aspx.cs" Inherits="OnlineExamWeb.Connection" %>
...
<body>
                 ...
                 <nav class="sidebar-nav">
                        <ul id="sidebarnav">
                            ...
                            <li class="sidebar-item "><a class="sidebar-link sidebar-link " href="Results.aspx"
                              ...
                              <li class="sidebar-item selected"><a class="sidebar-link sidebar-link active" href="Connection.aspx"
                                aria-expanded="false"><i data-feather="database" class="feather-icon"></i><span
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Connections</h3>
    ...
    <script>
        ...
        function loadbatchforedit(id) {
            $.ajax({
                type: "GET",
                url: $("#hdnapi").val() + id + "/getconnections",
                //data: '{"productid" : "0"}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
