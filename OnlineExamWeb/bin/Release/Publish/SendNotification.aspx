<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SendNotification.aspx.cs" Inherits="OnlineExamWeb.SendNotification" %>
            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item selected"><a class="sidebar-link sidebar-link active" href="SendNotification.aspx"
                                ...
                                <form id="id" runat="server">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <label class="col-lg-2">Data to send</label>
                                                <div class="col-lg-10">
                                                    <textarea class="form-control" rows="10" runat="server" id="txtdata" placeholder="Category Description"></textarea>
                                                </div>
                                            </div>
                                        </div>
