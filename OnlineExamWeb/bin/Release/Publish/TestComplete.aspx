<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TestComplete.aspx.cs" Inherits="OnlineExamWeb.TestComplete" %>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Test Result</h3>
                            ...
                            <div class="card-body">
                                ...
                                <form id="form1" runat="server">
                                    ...
                                    <div class="jumbotron text-center">
                                        <h1 class="display-3">Thank You for taking Test!</h1>
                                        <h2 id="hTotalQuestions" runat="server"></h2>
                                        <h2 id="hTotalAttemptQuestions" runat="server"></h2>
                                        <h2 id="hTotalCorrectQuestions" runat="server"></h2>
                                        <h2 id="hMarksObtained" runat="server"></h2>
                                        <div id="dvRedirect" runat="server">
                                        </div>
                                        ...
                                        <p class="lead">
                                            <a class="btn btn-primary btn-sm" href="Visitor.aspx" role="button">Continue to homepage</a>
                                        </p>
                                    </div>
                                </form>
