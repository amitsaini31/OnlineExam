<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserBatch.aspx.cs" Inherits="OnlineExamWeb.UserBatch" %>
            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                     <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item selected"><a class="sidebar-link sidebar-link active" href="UserBatch.aspx"
            ...
            <div class="container-fluid">
                                    ...
                                    <div class="form-body">
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-10">
                                                    <input type="text" class="form-control" runat="server" id="txtbatchname"
                ...
                <div class="row" id="dvView">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">View Batch</h4>
                                <h6 class="card-subtitle">Batch are created to categorise users.</h6>
                                <div class="form-body">
                                    <div class="form-group">
                                        <div class="form-actions">
                                            <div class="text-left">
                ...
                <div class="modal-dialog modal-dialog-centered modal-sm">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="text-center" id="mdladdusers">
        ...
        function Onloadbatch(response) {
            ...
            if (obj.Table.length == 0) {
                ...
                for (var i = 0; i < obj.Table.length; i++) {
                    ...
                    str = str + "<tr data-id='" + item.ID + "'><td  style='text-align:left;'>" + item.BatchName +
                ...
                $('tr').click(function () {
                    ...
                    $("#mdltitle").html("ID : "
                        + $(this).attr('data-id'));
                    $("#mdladdusers").html("<a class='btn btn-primary' href='UserBatchMap.aspx?code="
                        + $(this).attr('data-id') + "'>Add Users</a> ");
