<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminHome.aspx.cs" Inherits="OnlineExamWeb.AdminHome" %>
...
<body>
    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed" data-boxed-layout="full">
        ...
        <aside class="left-sidebar" data-sidebarbg="skin6">
            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="sidebar-item selected"><a class="sidebar-link sidebar-link active" href="AdminHome.aspx"
                            aria-expanded="false"><i data-feather="home" class="feather-icon"></i><span
                                class="hide-menu">Dashboard</span></a></li>
                        <li class="list-divider"></li>
                        <li class="nav-small-cap"><span class="hide-menu">Applications</span></li>

                        <li class="sidebar-item "><a class="sidebar-link sidebar-link " href="SendNotification.aspx"
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- Start Page Content -->
                <!-- ============================================================== -->
                <div class="row" id="dvAdd">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Add Category</h4>
                                <h6 class="card-subtitle">Add new category for question papers.</h6>
                                    ...
                                    <div class="form-body">
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-10">
                                                    <input type="text" class="form-control" runat="server" id="txtcategoryname"
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <label class="col-lg-2">Category Description</label>
                                                <div class="col-lg-10">
                                                    <textarea class="form-control" rows="3" runat="server" id="txtcategorydesc" placeholder="Category Description"></textarea>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="row" id="dvView">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">View Category</h4>
                                <h6 class="card-subtitle">Categories are added to categorise question papers.</h6>
                                <div class="form-body">
                                    <div class="form-group">
                                        <div class="form-actions">
                                            <div class="text-left">
    ...
    <script>
        ...
        function loadcategory() {
            $.ajax({
                type: "GET",
                url: $("#hdnapi").val() + "/getcategory",
                //data: '{"productid" : "0"}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: Onloadcategory,
        ...
        function Onloadcategory(response) {
            ...
            if (obj.Table.length == 0) {
                ...
                for (var i = 0; i < obj.Table.length; i++) {
                    ...
                    str = str + "<tr><td  style='text-align:left;'>" + item.CategoryName + "</td><td  style='text-align:left;'>" + item.CategoryDesc + "</td><td><a href='#' onclick='loadcategoryforedit(" + item.ID + ")' ><i class='fas fa-edit action edit' ></i></a><a href='#' onclick='loadcategoryforedit(" + item.ID + ")' data-original-title='Delete'><i class='fas fa-trash delete'></i></a></td></tr>";
                }
                $("#tbody").html(str);
                $("#tblView").show();
                $("#dvAdd").hide();
        ...
        function loadcategoryforedit(id) {
            $.ajax({
                type: "GET",
                url: $("#hdnapi").val() + id + "/getcategory",
                //data: '{"productid" : "0"}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: Onloadcategoryforedit,
                failure: function (response) {
                    alert(response.responseText);
                },
                error: function (response) {
        ...
        function Onloadcategoryforedit(response) {
            var obj = jQuery.parseJSON(response);
            debugger;
            //var Title = obj.Table.length;
            var str = "";
            ...
            for (var i = 0; i < obj.Table.length; i++) {
                ...
                $("#txtcategorydesc").val(item.CategoryDesc);
                $("#hdnid").val(item.ID);
            }
            $("#dvAdd").show();
            $("#dvView").hide();
